...
const SOURCE_PROJECT = "822776729892"; /* specify a value here only in case your source data sits in a project other than the default defined in workflow_settings.yaml defaultDatabase variable. You would need to grant the Dataform service account BigQuery Data Viewer and BigQuery Job User access to the dataset. */
...
const INTERMEDIATE_DATASET = "staging";
const OUTPUT_DATASET = "tmp";
const START_DATE = 20250101; /* data will be pulled starting this date */
